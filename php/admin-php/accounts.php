                ...
                <table class="table table-striped table-sm">
                  ...
                  <tbody>
                    <?php
                        ...
                        $sql = "select id_number, user_type, first_name, last_name, password, email from user";
                        $result = $connection -> query($sql);

                        if ($result -> num_rows > 0) {
                            echo "<table>";
                            while ($row = $result -> fetch_assoc()) {
                                echo "<tr><td>" . $row['first_name'] . "</td><td>" . $row['last_name'] . "</td><td>" . $row['id_number'] . "</td><td>" . $row['user_type'] . "</td></tr>";
                            }
                            echo "</table>";
                        } else {
                            echo "No results.";
