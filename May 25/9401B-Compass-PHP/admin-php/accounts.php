<!-- This php file will display the data of user accounts for the admin interface (coded by Mr. Laban) -->
<!DOCTYPE html>
<html>
    <head>
        <title>SAMCIS classrooms | accounts</title>
        <meta charset="utf-8">
                    ...
                    <?php
                        ...
                        if ($result -> num_rows > 0) {
                            ...
                            while ($row = $result -> fetch_assoc()) {
                                echo "<tr><td>" . $row['first_name'] . "</td><td>" . $row['last_name'] . "</td><td>" . $row['id_number'] . "</td><td>" . $row['user_type'] . "</td></tr>"; //this will display the data requested in a table format
                            }
                            echo "</table>";
                        } else {
                            echo "No results.";
