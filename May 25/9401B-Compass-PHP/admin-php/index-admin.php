                ...
                <table class="table table-striped table-sm">
                  ...
                  <tbody>
                    ...
                    <?php
                        ...
                        $sql = "select user_type, first_name, last_name from user"; //query for the user table
                        $result = $connection -> query($sql);

                        if ($result -> num_rows > 0) {
                            echo "<table>";
                            while ($row = $result -> fetch_assoc()) {
                                echo "<tr><td>" . $row['first_name'] . "</td><td>" . $row['last_name'] . "</td><td>" .  $row['user_type'] . "</td></tr>"; //this will display the data requested in a table format
                            }
                            echo "</table>";
                        } else {
                            echo "No results.";
