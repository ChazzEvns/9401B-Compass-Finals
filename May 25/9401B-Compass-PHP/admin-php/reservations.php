<!-- This php file will display the reservations made by users (coded by Mr. Laban) -->
<!DOCTYPE html>
<html>
    <head>
                ...
                <table class="table table-striped table-sm">
                  ...
                  <tbody>
                    ...
                    <?php
                        ...
                        $sql = "select room_number, time_res, date_res from reservation"; //query for the user table
